...
public class ComponentMyBatisHelperTest {
    ...
    public void testGetEntityAnnotation() {
        ...
        Assertions.assertThat(Assertions.catchThrowable(() -> ComponentMyBatisHelper.getEntityAnnotation(ComponentFactory.getInstance().getDescriptor(IFake.class))))
                .isInstanceOf(IllegalArgumentException.class).hasMessage("Not found annotation Entity for Component=interface com.talanlabs.mybatis.test.data.IFake");
        Assertions.assertThat(Assertions.catchThrowable(() -> ComponentMyBatisHelper.getEntityAnnotation(ComponentFactory.getInstance().getDescriptor(IFake2.class))))
                .isInstanceOf(IllegalArgumentException.class).hasMessage("Not name in Entity for Component=interface com.talanlabs.mybatis.test.data.IFake2");
    }
    ...
    public void testGetColumnAnnotation() {
        ...
        Assertions.assertThat(Assertions.catchThrowable(() -> ComponentMyBatisHelper
                ...
                .isInstanceOf(IllegalArgumentException.class).hasMessage("Not name in Column for Component=interface com.talanlabs.mybatis.test.data.IFake with property=name2");
    }
    ...
    public void testGetNlsColumnAnnotation() {
        ...
        Assertions.assertThat(Assertions.catchThrowable(() -> ComponentMyBatisHelper
                ...
                .isInstanceOf(IllegalArgumentException.class).hasMessage("Not name in NlsColumn for Component=interface com.talanlabs.mybatis.test.data.IFake with property=name3");
    }
    ...
    public void testGetVersionAnnotation() {
        ...
        Assertions.assertThat(Assertions.catchThrowable(() -> ComponentMyBatisHelper
                ...
                .isInstanceOf(IllegalArgumentException.class).hasMessage("Not int or long return type of Version for Component=interface com.talanlabs.mybatis.test.data.IFake with property=name2");
    }
    ...
    public void testBuildSetNlsColumn() {
        Assertions.assertThat(ComponentMyBatisHelper.buildSetNlsColumn(ComponentFactory.getInstance().getDescriptor(ICountry.class),
                ComponentFactory.getInstance().getDescriptor(ICountry.class).getPropertyDescriptor(CountryFields.name))).isEqualTo("NAME = #{name,javaType=java.lang.String}");
        Assertions.assertThat(ComponentMyBatisHelper
                .buildSetNlsColumn(ComponentFactory.getInstance().getDescriptor(IFake.class), ComponentFactory.getInstance().getDescriptor(IFake.class).getPropertyDescriptor(FakeFields.name)))
                .isNull();
    }
    ...
    public void testBuildSetIdColumn() {
        Assertions.assertThat(ComponentMyBatisHelper
                ...
                .isEqualTo("ID = #{id,javaType=com.talanlabs.entity.IId}");
        Assertions.assertThat(Assertions.catchThrowable(() -> ComponentMyBatisHelper.buildSetIdColumn(ComponentFactory.getInstance().getDescriptor(ICountry.class),
                ...
                .hasMessage("Not present annotation Id for Component=interface com.talanlabs.mybatis.test.data.ICountry with property=code");
    }
    ...
    public void testBuildSetVersionColumn() {
        ...
        Assertions.assertThat(Assertions.catchThrowable(() -> ComponentMyBatisHelper.buildSetVersionColumn(ComponentFactory.getInstance().getDescriptor(ICountry.class),
                ComponentFactory.getInstance().getDescriptor(ICountry.class).getPropertyDescriptor(CountryFields.code)))).isInstanceOf(IllegalArgumentException.class)
                .hasMessage("Not present annotation Version for Component=interface com.talanlabs.mybatis.test.data.ICountry with property=code");
    }
