...
public interface ITrain4 extends IEntity {
    ...
    @Collection(propertyTarget = WagonFields.trainId, orderBy = { @OrderBy(property = WagonFields.position, sort = OrderBy.Sort.Asc), @OrderBy(property = WagonFields.code, sort = OrderBy.Sort.Asc) })
