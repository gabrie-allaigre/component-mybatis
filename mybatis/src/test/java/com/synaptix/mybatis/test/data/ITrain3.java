...
@Entity(name = "T_TRAIN")
@ComponentBean
public interface ITrain3 extends IEntity {
    ...
    @Collection(propertyTarget = WagonFields.trainId, orderBy = @OrderBy(property = WagonFields.position, sort = OrderBy.Sort.Desc))
